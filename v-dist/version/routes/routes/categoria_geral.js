...
module.exports = function (app) {
  ...
  app.route('/categoria_geral/:empresa').all(app.auth.authenticate()).get(function (req, res) {
  ...
  app.route('/categoria_geral/:empresa/:id').all(app.auth.authenticate()).get(function (req, res) {
    /**Contem o objeto de Tasks, que está na pasta models */
    var Categorias_Geral = utils.getModel(req.params.empresa, 'categoria_geral');
